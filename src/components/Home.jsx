  ...
  return (
    <div className='home h-screen text-center'>
      ...
      <div className="Arrival  bg-gray-200 w-full pt-20 pb-8 ">
        <h4 className='lg:text-xl text-gray-400 md:text-[10px] sm:text-[8px]'>NEW ARRIVAL</h4>
        <h1 className='lg:text-4xl Font-Nerko  mt-6 md:text-[28px] sm:text-[18px] '>Discover the Latest Additions at Your Top Choice Shopping Centre</h1>
      ...
      {/* Left div with image */}
      <div className="lg:w-2/5 lg:h-[500px] mt-10  md:w-[200px] md:h-[300px] sm:w-[180px] sm:h-[200px]" >
        <img 
          src={imagecamera}
          alt="Placeholder" 
...
<div className="Stocks  bg-gray-200 w-full pt-20 pb-8">
        <h4 className='lg:text-xl text-gray-400 md-text-lg sm:text-[12px]'>Our Stocks</h4>
        <h1 className='lg:text-4xl Font-Nerko  mt-6 mb-2 md:text-[30px] sm:text-[20px]'>Discover the Latest Additions at Your Top Choice Shopping Website</h1>
