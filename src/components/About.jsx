  ...
  return (
    <div>
      ...
      <div className=" h-5/6 w-full text-center text-gray-600"
        ...
        <p className='text-gray-100 w-2/4 h-12 ml-80 pl-8 mt-14 text-lg font-bold'>Share some details here. This is Flexible section where you can share anything you want. It could be details or some information.</p>
       
      </div>
    </div>
    <div className="flex h-[550px] bg-white">
      {/* Left Div for images */}
      <div className="w-1/2 flex items-center justify-around p-4 ml-10">
      <img src={piccc} alt="Second" className="h-[400px] object-cover w-[280px]" style={{borderRadius:'56% 44% 94% 6% / 33% 100% 0% 67%'}} />
        <img src={randomimg} alt="First" className="h-full object-cover " style={{borderRadius:'48% 52% 100% 0% / 100% 100% 0% 0%'}} />
       
      </div>

      {/* Right Div for text */}
      <div className="w-1/2 flex flex-col justify-center p-4">
        <h4 className="text-lg font-semibold mb-2">About All In One</h4>
        <h1 className="text-5xl font-bold mb-4 Font-Nerko">Crafting timeless pieces for your everyday style</h1>
        <p className="text-base">At the heart of our brand lies a passion for creating clothing that empowers individuals to express their unique style with confidence. Our designs blend timeless elegance with modern trends, ensuring every piece is crafted to not only look good but feel great. Whether it’s your go-to casual wear or a statement outfit, we believe fashion should be a reflection of your inner self. Using high-quality fabrics and sustainable practices, we strive to bring you collections that are as comfortable as they are stylish. We’re more than just fashion – we’re a community that celebrates individuality and self-expression.</p>
      </div>
    </div>
    <div className='bg-gray-800 h-[750px]'>
    <div className="flex h-[550px] ">
      {/* Left Div for images */}
      <div className="w-1/2 flex flex-col justify-center p-4 ml-10">
        <h4 className="text-lg font-semibold mb-2 text-gray-400">Our story</h4>
        <h1 className="text-5xl font-bold mb-4 Font-Nerko text-gray-50">from a siple man to the all in one owner</h1>
        <p className="text-base text-gray-100">Once upon a time, there was a young entrepreneur named Anas, who had a passion for fashion, technology, and the artistry of jewelry. Growing up, she often dreamed of running her own business, but the thought of blending these vastly different industries into one seemed impossible. Still, Maya believed that people, like herself, had eclectic tastes that could span from cutting-edge electronics to timeless fashion and sparkling jewels. So why not bring them together?
...
Anas started small. With a simple idea, she sketched out plans for an online store, a space where clothing, electronics, and jewelry could coexist beautifully. But launching such a business was no easy feat. She had a vision of curating high-quality, fashionable clothes, innovative electronics, and handcrafted jewelry that spoke to both elegance and style. However, she had no prior experience running a store.</p>
      ...
      <div className="w-1/2 flex items-center justify-around p-4 ml-10">
        ...
        <img src={imagecamera} alt="First" className="h-full object-cover w-[500px] -translate-y-16 " style={{borderRadius:'48% 52% 49% 51% / 100% 100% 0% 0%'}} />
    ...
    <div className="box h-[600px] w-screen flex justify-center mt-16 bg-gray-200"><div className="contactbox h-[600px] w-4/5 text-center " style={{backgroundImage:`url(${lastback})`,backgroundSize:'cover',backgroundPosition:'center'}}>
    <h1 className="text-5xl font-bold mb-4 Font-Nerko text-gray-50 mt-48">Contact us on provided Links</h1>
   <ul className='flex gap-7 ml-[500px] mt-16'>
    <li><NavLink to='https://www.facebook.com/anas.amir.7311352'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#eee5e5"} fill={"none"}  className='hover:text-gray-400'>
    ...
    <li><NavLink to='https://www.instagram.com/anasparacha223/' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#eee5e5"} fill={"none"} className='hover:text-gray-400'>
    ...
    <li><NavLink to='https://web.whatsapp.com/'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#eee5e5"} fill={"none"} className='hover:text-gray-400'>
    ...
    <li><NavLink to='https://www.linkedin.com/in/anas-amir-874876265/'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#eee5e5" fill="none" className='hover:text-gray-400'>
